	...
	<div class="row">
		...
		<div class="col-md-8">
			...
			<div class="edg-metadata closereadings-metadata">
				<?php
					if (get_field("primary_text_author") == true) {
						echo "<p class='edg-metadata-name'><strong>Primary Text Author</strong>: ". get_field("primary_text_author") . "</p>\n";
					}
					if (get_field("secondary_text_title") == true) {
						echo "<p class='edg-metadata-name'><strong>Secondary Text Title</strong>: ". get_field("secondary_text_title") . "</p>\n";
					}	
